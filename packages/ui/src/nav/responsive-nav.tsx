  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:block">
        ...
        >
          <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
          <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-8 py-1 text-body md:text-md-body lg:text-lg-body font-medium text-white backdrop-blur-3xl">
            Lets Chat
          </span>
        </button>
      </div>
