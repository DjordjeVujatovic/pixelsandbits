    ...
    >
      ...
      <div className="hidden lg:block">
        ...
        >
          ...
          <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-[9999px] bg-slate-950 px-8 py-1 text-body md:text-md-body lg:text-lg-body font-medium text-white backdrop-blur-3xl isolate">
            Lets Chat
          </span>
        </button>
      </div>
