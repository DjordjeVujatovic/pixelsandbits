            ...
            <div className="relative h-80 w-full">
              <AnimatePresence>
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    <BackgroundGradient>
                      <div className="h-[250px] w-full bg-gradient-to-r from-black to-neutral-900 flex flex-col md:flex-row items-center rounded-3xl object-cover object-center brightness-125 hover:brightness-150 transition-all duration-300 p-4 gap-6">
                        <Image
